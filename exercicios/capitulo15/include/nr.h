...
bool decchk(const string& str, char &ch);
...
// body file: addint.cpp
// body file: cntab2.cpp
// body file: frprmn.cpp
// body file: metrop.cpp
// body file: quad3d.cpp
// body file: snrm.cpp
// body file: airy.cpp
// body file: convlv.cpp
// body file: ftest.cpp
// body file: mgfas.cpp
// body file: quadct.cpp
// body file: sobseq.cpp
// body file: amebsa.cpp
// body file: copy.cpp
// body file: gamdev.cpp
// body file: mglin.cpp
// body file: quadmx.cpp
// body file: solvde.cpp
// body file: amoeba.cpp
// body file: correl.cpp
// body file: gammln.cpp
// body file: midexp.cpp
// body file: quadvl.cpp
// body file: sor.cpp
// body file: amotry.cpp
// body file: cosft1.cpp
// body file: gammp.cpp
// body file: midinf.cpp
// body file: ran0.cpp
// body file: sort1.cpp
// body file: amotsa.cpp
// body file: cosft2.cpp
// body file: gammq.cpp
// body file: midpnt.cpp
// body file: ran1.cpp
// body file: sort2.cpp
// body file: anneal.cpp
// body file: covsrt.cpp
// body file: gasdev.cpp
// body file: midsql.cpp
// body file: ran2.cpp
// body file: sort3.cpp
// body file: anorm2.cpp
// body file: crank.cpp
// body file: gaucof.cpp
// body file: midsqu.cpp
// body file: ran3.cpp
// body file: spctrm.cpp
// body file: arcmak.cpp
// body file: cyclic.cpp
// body file: gauher.cpp
// body file: miser.cpp
// body file: ran4.cpp
// body file: spear.cpp
// body file: arcode.cpp
// body file: daub4.cpp
// body file: gaujac.cpp
// body file: mmid.cpp
// body file: rank.cpp
// body file: sphbes.cpp
// body file: arcsum.cpp
// body file: dawson.cpp
// body file: gaulag.cpp
// body file: mnbrak.cpp
// body file: ranpt.cpp
// body file: sphfpt.cpp
// body file: asolve.cpp
// body file: dbrent.cpp
// body file: gauleg.cpp
// body file: mnewt.cpp
// body file: ratint.cpp
// body file: sphoot.cpp
// body file: atimes.cpp
// body file: ddpoly.cpp
// body file: gaussj.cpp
// body file: moment.cpp
// body file: ratlsq.cpp
// body file: splie2.cpp
// body file: avevar.cpp
// body file: decchk.cpp
// body file: gcf.cpp
// body file: mp2dfr.cpp
// body file: ratval.cpp
// body file: splin2.cpp
// body file: badluk.cpp
// body file: df1dim.cpp
// body file: golden.cpp
// body file: mpdiv.cpp
// body file: rc.cpp
// body file: spline.cpp
// body file: balanc.cpp
// body file: dfpmin.cpp
// body file: gser.cpp
// body file: mpinv.cpp
// body file: rd.cpp
// body file: splint.cpp
// body file: banbks.cpp
// body file: dfridr.cpp
// body file: hpsel.cpp
// body file: mpmul.cpp
// body file: realft.cpp
// body file: spread.cpp
// body file: bandec.cpp
// body file: dftcor.cpp
// body file: hpsort.cpp
// body file: mpops.cpp
// body file: rebin.cpp
// body file: sprsax.cpp
// body file: banmul.cpp
// body file: dftint.cpp
// body file: hqr.cpp
// body file: mppi.cpp
// body file: red.cpp
// body file: sprsin.cpp
// body file: bcucof.cpp
// body file: difeq.cpp
// body file: hufapp.cpp
// body file: mprove.cpp
// body file: relax.cpp
// body file: sprspm.cpp
// body file: bcuint.cpp
// body file: dlinmin.cpp
// body file: hufdec.cpp
// body file: mpsqrt.cpp
// body file: relax2.cpp
// body file: sprstm.cpp
// body file: beschb.cpp
// body file: eclass.cpp
// body file: hufenc.cpp
// body file: mrqcof.cpp
// body file: resid.cpp
// body file: sprstp.cpp
// body file: bessi.cpp
// body file: eclazz.cpp
// body file: hufmak.cpp
// body file: mrqmin.cpp
// body file: revcst.cpp
// body file: sprstx.cpp
// body file: bessi0.cpp
// body file: ei.cpp
// body file: hunt.cpp
// body file: newt.cpp
// body file: reverse.cpp
// body file: stifbs.cpp
// body file: bessi1.cpp
// body file: eigsrt.cpp
// body file: hypdrv.cpp
// body file: odeint.cpp
// body file: rf.cpp
// body file: stiff.cpp
// body file: bessik.cpp
// body file: elle.cpp
// body file: hypgeo.cpp
// body file: orthog.cpp
// body file: rj.cpp
// body file: stoerm.cpp
// body file: bessj.cpp
// body file: ellf.cpp
// body file: hypser.cpp
// body file: pade.cpp
// body file: rk4.cpp
// body file: svbksb.cpp
// body file: bessj0.cpp
// body file: ellpi.cpp
// body file: icrc.cpp
// body file: pccheb.cpp
// body file: rkck.cpp
// body file: svdcmp.cpp
// body file: bessj1.cpp
// body file: elmhes.cpp
// body file: icrc1.cpp
// body file: pcshft.cpp
// body file: rkdumb.cpp
// body file: svdfit.cpp
// body file: bessjy.cpp
// body file: erfcc.cpp
// body file: igray.cpp
// body file: pearsn.cpp
// body file: rkqs.cpp
// body file: svdvar.cpp
// body file: bessk.cpp
// body file: erff.cpp
// body file: indexx.cpp
// body file: period.cpp
// body file: rlft3.cpp
// body file: toeplz.cpp
// body file: bessk0.cpp
// body file: erffc.cpp
// body file: interp.cpp
// body file: piksr2.cpp
// body file: rofunc.cpp
// body file: tptest.cpp
// body file: bessk1.cpp
// body file: eulsum.cpp
// body file: irbit1.cpp
// body file: piksrt.cpp
// body file: rotate.cpp
// body file: tqli.cpp
// body file: bessy.cpp
// body file: evlmem.cpp
// body file: irbit2.cpp
// body file: pinvs.cpp
// body file: rsolv.cpp
// body file: trapzd.cpp
// body file: bessy0.cpp
// body file: expdev.cpp
// body file: jacobi1.cpp
// body file: plgndr.cpp
// body file: rstrct.cpp
// body file: tred2.cpp
// body file: bessy1.cpp
// body file: expint.cpp
// body file: jacobn.cpp
// body file: poidev.cpp
// body file: rtbis.cpp
// body file: tridag.cpp
// body file: beta.cpp
// body file: f1dim.cpp
// body file: julday.cpp
// body file: polcoe.cpp
// body file: rtflsp.cpp
// body file: trncst.cpp
// body file: betacf.cpp
// body file: factln.cpp
// body file: kendl1.cpp
// body file: polcof.cpp
// body file: rtnewt.cpp
// body file: trnspt.cpp
// body file: betai.cpp
// body file: factrl.cpp
// body file: kendl2.cpp
// body file: poldiv.cpp
// body file: rtsafe.cpp
// body file: ttest.cpp
// body file: bico.cpp
// body file: fasper.cpp
// body file: kermom.cpp
// body file: polin2.cpp
// body file: rtsec.cpp
// body file: tutest.cpp
// body file: bksub.cpp
// body file: fdjac.cpp
// body file: ks2d1s.cpp
// body file: polint.cpp
// body file: rzextr.cpp
// body file: twofft.cpp
// body file: bnldev.cpp
// body file: fgauss.cpp
// body file: ks2d2s.cpp
// body file: powell.cpp
// body file: savgol.cpp
// body file: vander.cpp
// body file: brent.cpp
// body file: ksone.cpp
// body file: predic.cpp
// body file: scrsho.cpp
// body file: vegas.cpp
// body file: broydn.cpp
// body file: fit.cpp
// body file: kstwo.cpp
// body file: probks.cpp
// body file: select.cpp
// body file: voltra.cpp
// body file: bsstep.cpp
// body file: fitexy.cpp
// body file: laguer.cpp
// body file: psdes.cpp
// body file: selip.cpp
// body file: wt1.cpp
// body file: caldat.cpp
// body file: fixrts.cpp
// body file: lfit.cpp
// body file: pwt.cpp
// body file: sfroid.cpp
// body file: wtn.cpp
// body file: chder.cpp
// body file: fleg.cpp
// body file: linbcg.cpp
// body file: pwtset.cpp
// body file: shell.cpp
// body file: wwghts.cpp
// body file: chebev.cpp
// body file: flmoon.cpp
// body file: linmin.cpp
// body file: pythag.cpp
// body file: shoot.cpp
// body file: zbrac.cpp
// body file: chebft.cpp
// body file: fmin.cpp
// body file: lnsrch.cpp
// body file: pzextr.cpp
// body file: shootf.cpp
// body file: zbrak.cpp
// body file: chebpc.cpp
// body file: four1.cpp
// body file: locate.cpp
// body file: qgaus.cpp
// body file: simp1.cpp
// body file: zbrent.cpp
// body file: chint.cpp
// body file: fourew.cpp
// body file: lop.cpp
// body file: qrdcmp.cpp
// body file: simp2.cpp
// body file: zrhqr.cpp
// body file: chixy.cpp
// body file: fourfs.cpp
// body file: lubksb.cpp
// body file: qromb.cpp
// body file: simp3.cpp
// body file: zriddr.cpp
// body file: choldc.cpp
// body file: fourn.cpp
// body file: ludcmp.cpp
// body file: qromo.cpp
// body file: simplx.cpp
// body file: zroots.cpp
// body file: cholsl.cpp
// body file: fpoly.cpp
// body file: machar.cpp
// body file: qroot.cpp
// body file: simpr.cpp
// body file: chsone.cpp
// body file: fred2.cpp
// body file: matadd.cpp
// body file: qrsolv.cpp
// body file: sinft.cpp
// body file: chstwo.cpp
// body file: fredex.cpp
// body file: matsub.cpp
// body file: qrupdt.cpp
// body file: slvsm2.cpp
// body file: cisi.cpp
// body file: fredin.cpp
// body file: medfit.cpp
// body file: qsimp.cpp
// body file: slvsml.cpp
// body file: cntab1.cpp
// body file: frenel.cpp
// body file: memcof.cpp
// body file: qtrap.cpp
// body file: sncndn.cpp

// body file: xsphfpt.cpp
